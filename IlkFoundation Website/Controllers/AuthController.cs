...
namespace test_ngo.Controllers
{
    public class AuthController : Controller
    {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        {
                            // Store the email in session instead of the UID for consistent display
                            HttpContext.Session.SetString("currentUser", register.Email);
        ...
        public IActionResult LogOut()
        {
            ...
            // Clear other session data or authentication cookies if necessary
